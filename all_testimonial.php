    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/we-provide-bg1.webp">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12">
              <h2 class="text-theme-colored2 font-36">الآحداث والفعاليات</h2>
              <ol class="breadcrumb   mt-10 white">
                <li><a href="index.php">الرئيسية</a></li>
                <li class="active">  
الآحداث والفعاليات</li>
              </ol>
            </div>
          </div>
        </div>
                  ...
                  <div class="entry-meta media no-bg no-border mt-0 mb-10">
                    <div class="media-body pl-0">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="testimonial.php?ID=<? echo $row['ID']; ?>"><? echo  strip_tags(substr($row['address'],0,60)); ?> </a></h4>
                      ...
                      <p class="mt-5"><? echo strip_tags(substr($row['news'],0,410)); ?></p>
											<a class="btn btn-default btn-flat font-12 mt-10 ml-5" href="testimonial.php?ID=<? echo $row['ID']; ?>">إقرأ المزيد</a>
                </div>
              </article>
            </div><? } ?>
