...
<input  required="required"   name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $i++;?>" style="width: 100%" checked    ></font></span></td>
										<td width="84">
										<font face="Tahoma" size="2">
										 <textarea  required="required"   rows="2" name="T6[]" cols="20" style="width: 100%; height: 64"><?php echo $row['youtube']; ?></textarea></font></td>
										<td width="116" >
										<font face="Tahoma" size="2">
										 <textarea  required="required"   rows="2" name="T5[]" cols="20" style="width: 100%; height: 64"><?php echo $row['whatsapp']; ?></textarea></font></td>
										<td width="106" >
										<font face="Tahoma" size="2">
										 <textarea  required="required"   rows="2" name="T4[]" cols="20" style="width: 100%; height: 64"><?php echo $row['linked']; ?></textarea></font></td>
										<td width="118">
										<font face="Tahoma" size="2">
										 <textarea  required="required"   rows="2" name="T3[]" cols="20" style="width: 100%; height: 64"><?php echo $row['instagram']; ?></textarea></font></td>
										<td width="84">
										<font face="Tahoma" size="2">
										 <textarea  required="required"   rows="2" name="T2[]" cols="20" style="width: 100%; height: 64"><?php echo $row['twitter']; ?></textarea></font></td>
										<td width="114">
										<font face="Tahoma" size="2">
										<textarea  required="required"   rows="2" name="T1[]" cols="20" style="width: 100%; height: 64"><?php echo $row['facebook']; ?></textarea></font></td>
...
$sql="UPDATE  media  set facebook='$T1',twitter='$T2',instagram='$T3',linked='$T4',whatsapp='$T5',youtube='$T6' where ID='$ID'";
