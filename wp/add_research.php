...
include("conn.php");
$result2=mysqli_query($conn,"select * from sub where type=5");
 ...
 <? } ?>
					...
					<tr>
						...
						<td align="right"  dir="rtl" height="32" width="32%" colspan="3">
							...
							<input      name="T1" id="T1" size="20"  required   class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل عنوان البحث
" ></font></td>
 ...
 (English)</font></td>
					...
					<tr>
						<td align="center"   dir="rtl" height="32" width="18%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">تاريخ البحث
</font></td>
						...
						<td align="right"  dir="rtl" height="32" width="13%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">مصدر البحث
</font></td>
						<td align="right"  dir="rtl" height="32" width="35%">
							<font face="Droid Arabic Kufi" size="2">				 										
						
							<input      name="T3"   size="20"  required     class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل مصدر البحث
" ></font></td>
					</tr>
					<tr>
...
$sql="insert into  research	 set  page_no='$page_no',type=1,address='$T1',news='$S1',address_en='$T2',news_en='$S22',photo='$name',day='$day',mans='$mans',year='$year',sorc='$T3'  ";
