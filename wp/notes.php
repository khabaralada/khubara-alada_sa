...
where user_cors.cors_ID=reg_cors.no  and cors.cors_ID=subjects.cors_ID and address=cors.ID  and reg_cors.no='$ss'";
                ...
                ?>
                    <tr>
                      ...
                      <td align="right">
                        <p align="center"><?php echo $row['start_date_en']; ?>
                      </td>
                      <td align="right">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <form action="" method="post">
                              <div class="modal-header">
                                <b>
                                  <font face="Droid Arabic Kufi" size="5">ارسال بريد للمتدرب : <?php echo $row['name']; ?></font>
                                  <font size="5"></font>
                                </b>
                              </div>
                              <div class="modal-body">
            ...
            <form role="form" action="" method="post">
              ...
              <div class="row">
                ...
                <div class="form-group col-xs-12">
                  ...
                  <input type="submit" value="حفظ البيانات" name="B1" class="btn btn-primary" style="float: left"> <br>
                </div>
              </div>
              ...
              ?><table class="table table-striped">
                  <tr>
                    <th align="center" height="25">
                      <p align=center> الحالة </p>
                    </th>
                    <th align="center" height="25">
                      <p align=center>مبلغ الدورة</p>
                    </th>
                    <th align="center" height="25">
                      <p align=center>المدفوع
                    </th>
                    <th align="center" height="25">
                      <p align=center>التاريخ</p>
                    </th>
                    <th align="center" height="25">
                      <p align=center>ملاحظات </p>
                    </th>
                      ...
                      <form role="form" action="" method="post">
                        ...
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi">
                            ...
                            <?php if ($row['Status'] == 8) echo '<font color=red><i class="fa fa-inbox fa-2x" aria-hidden="true" ></i>ارسلت للصندوق</font>'; ?>
                        </td>

                        </font>
                        </td>
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi"><?php echo $row['amount']; ?></font>
                        </td>
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi"><?php echo $row['Paid']; ?></font>
                        </td>
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi"><?php echo $row['date']; ?> <?php echo $row['time']; ?></font>
                        </td>
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi"><?php echo $row['Notes']; ?></font>
                        </td>
                        <td align="center" height="25">
                        ...
                        <td align="center" height="25">
                          <font face="Droid Arabic Kufi"><?php echo $row['name']; ?></font>
                        </td>
                        ...
                        <td align="center" height="25" width="1">
                          <?php if ($row['user_ID'] == $_SESSION[user_ID]  and $maxID == $row['ID']) { ?>
                            <input type="submit" value="&#xf014;" formnovalidate class="btn btn-danger btn-icon fa fa-floppy-o " name="B2" formnovalidate onclick="return confirm('هل تريد الحذف البيانات ؟')" class="btn btn-danger" style="float: left"> <?php } ?>
                        </td>
                      </form>
                    </tr>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <form action="" method="post">
                              <div class="modal-header">
                                <b>
                                  <font face="Droid Arabic Kufi" size="5">تعديل البيانات </font>
                                  <font size="5"></font>
                                </b>
                              </div>
                              <div class="modal-body">
