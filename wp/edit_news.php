...
$sql="update news set  address='$T1',news='$S1',address_en='$T2',news_en='$S22',day='$day',mans='$mans',year='$year',sorc='$T3' where ID='$IDD'";
...
$sql="update news set  photo='$name'  where ID='$IDD'";
