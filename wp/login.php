...
echo $tot=round($row['co']/70*100);
 ...
 ?> %</td></tr><tr>
		<td bgcolor="#F0F0F0">
<div  >
<div class="progress-bar progress-bar-<?php if($tot>=100) echo 'info'; elseif($tot>=75) echo 'warning '; elseif($tot>=50) echo 'info'; elseif($tot>25) echo 'Info';  else  echo 'danger ';?> progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $tot; ?>%">
 ...
 <table id='example1'  class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
                        ...
                        <th align="right"><p align="center">اسم المسوق</th>
                        <th align="right"><p align="center">الحالات الجديدة  </th>
                        <th align="right"><p align="center">يرغب بالتسجيل</th>
                        <th align="right"><p align="center">لايرغب بالتسجيل</th>
                        <th align="right"><p align="center">غير مهتم</th>
                        <th align="right"><p align="center">لم يتم الرد</th>
                        <th align="right"><p align="center">الجوال مغلق</th>
                        <th align="right"><p align="center">متردد  </th>
                        <th align="right"><p align="center">ارسلت للصندوق</th>
                        <th align="right"><p align="center">المسددين</th>
 
                        <th align="right"><p align="center">المباع</th>
                        
                          <th align="right"><p align="center">مبالغ التسجيل بالفرع</th>
                           <th align="right"><p align="center">مبالغ تحويل علي الشركة</th>
                            <th align="right"><p align="center">مبالغ الدفع الالكتروني</th>
...
?>
 <tr>
                        ...
                        <td align="center"><p align="center"><?php $c++; echo $c; ?></td>
                        <td align="center"><p align="center"><?php echo $row['name']; ?></td>
						<td align="center"><p align="center"><?php
