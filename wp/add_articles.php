...
<table id='example1'  class="table table-bordered table-striped"  dir=rtl >
					...
					<tr>
						<td align="center"   dir="rtl" height="32" width="18%" bgcolor="#EEEEEE">
						<font face="Droid Arabic Kufi" size="2">الصفحة</font></td>
						<td align="right"  dir="rtl" height="32" width="80%" colspan="5">
							<select size="1" name="page_no" class="form-control" style="font-family: Arial; width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl" required="required" ><option></option>
<? $xx=5; ?>
...
include("conn.php");
$result2=mysqli_query($conn,"select * from sub where type=10");
while($row2=mysqli_fetch_array($result2))
{
?>  
<option value="<? echo $row2['sub_ID']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? echo $row2['sub']; ?></option>
 <? } ?>
							</select></td>
					</tr>
					<tr>
						...
						<td align="right"  dir="rtl" height="32" width="32%" colspan="3">
							...
							<input      name="T1" id="T1" size="20"  required   class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل عنوان المقال
" ></font></td>
 ...
 (English)</font></td>
					...
					<tr>
						<td align="center"   dir="rtl" height="32" width="18%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">تاريخ المقال
</font></td>
						...
						<td align="right"  dir="rtl" height="32" width="13%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">مصدر المقال
</font></td>
						<td align="right"  dir="rtl" height="32" width="35%">
							<font face="Droid Arabic Kufi" size="2">				 										
						
							<input      name="T3"   size="20"  required     class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل مصدر المقال
" ></font></td>
					</tr>
					<tr>
...
$sql="insert into  research	 set  page_no='$page_no',type=2,address='$T1',news='$S1',address_en='$T2',news_en='$S22',photo='$name',day='$day',mans='$mans',year='$year',sorc='$T3'  ";
