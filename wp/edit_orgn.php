...
$result=mysqli_query($conn,"select* from  orgn where ID='$ID'");
...
$sql="update orgn set  address='$T1',news='$S1',address_en='$T2',news_en='$S222',day='$day',mans='$mans',year='$year',sorc='$T3' where ID='$IDD'";
...
$sql="update orgn set  photo='$name'  where ID='$IDD'";
...
$sql="delete from orgn where ID='$IDD'";
