...
<table id='example1'  class="table table-bordered table-striped"  dir=rtl >
					...
					<tr>
						...
						<td align="right"  dir="rtl" height="32" width="32%" colspan="3">
							...
							<input   required="required"   name="T1" id="T1" size="20"     class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل عنوان الخبر" ></font></td>
						<td align="right"  dir="rtl" height="32" width="13%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">عنوان (English)</font></td>
					...
					<tr>
						...
						<td align="right"  dir="rtl" height="32" width="35%">
							...
							<input    required="required"  name="T3"   size="20"     class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:right" dir="rtl"  placeholder="    ادخل مصدر الخبر" ></font></td>
					</tr>
					<tr>
						<td align="right"   dir="rtl" height="32" width="18%" bgcolor="#EEEEEE">
						<p align="center">
...
$sql="insert into orgn  set  address='$T1',news='$S1',address_en='$T2',news_en='$S22',photo='$name',day='$day',mans='$mans',year='$year',sorc='$T3'  ";
...
echo '<meta http-equiv="refresh" content="1;url=add_orgn.php">';
}
}
