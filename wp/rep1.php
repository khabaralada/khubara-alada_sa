...
<div class="box-body">
 ...
 <th align="right"><p align="center"><font color="#FF0000">مبلغ الدورة</font></th>
...
$query = "select * from reg_cors,user_cors,subjects,cors 
where user_cors.cors_ID=reg_cors.no and user_ID='$_SESSION[user_ID]' and cors.cors_ID=subjects.cors_ID and address=cors.ID  and Supervisor='$ss' order by reg_cors.no DESC limit 500";
