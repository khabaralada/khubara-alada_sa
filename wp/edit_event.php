...
<table id='example1'  class="table table-bordered table-striped"  dir=rtl >
					...
					<tr>
						...
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">عنوان
						<span lang="ar-sa">الخبر</span> (English)</font></td>
					...
					<tr>
						<td align="right"   dir="rtl" height="32" width="18%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">تاريخ الخبر</font></td>
						...
						<td align="right"  dir="rtl" height="32" width="14%" bgcolor="#EEEEEE">
						<p align="center">
						<font face="Droid Arabic Kufi" size="2">مصدر الخبر</font></td>
						<td align="right"  dir="rtl" height="32" width="40%">
							<font face="Droid Arabic Kufi" size="2">				 										
					...
					<tr>
						...
						<div align="left">
							<table border="0" width="100%" dir="rtl" cellspacing="0" cellpadding="0">
								<tr>
									<td>
									<img border="0" src="../testimonial/<?php echo $row['photo']; ?>" width="300" ></td>
								</tr>
								<tr>
									<td>
...
$sql="update testimonial set  address='$T1',news='$S1',address_en='$T2',news_en='$S22',day='$day',mans='$mans',year='$year',sorc='$T3' where ID='$IDD'";
...
$sql="update testimonial set  photo='$name'  where ID='$IDD'";
...
$sql="delete from testimonial where ID='$IDD'";
