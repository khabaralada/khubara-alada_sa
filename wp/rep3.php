...
<div class="box-body">
 ...
 <th align="right"><p align="center"><font color="#FF0000">السعر</font></th>
...
where user_cors.cors_ID=reg_cors.no and   cors.cors_ID=subjects.cors_ID and address=cors.ID  and Supervisor='$ss' and   user_cors.com='$com' order by dates DESC";
elseif($_SESSION['acount_type']==2)
$query = "select * from reg_cors,user_cors,subjects,cors 
where user_cors.cors_ID=reg_cors.no and user_ID='$_SESSION[user_ID]' and cors.cors_ID=subjects.cors_ID and address=cors.ID  and  Supervisor='$ss' and   user_cors.com='$com' order by dates DESC";
elseif($_SESSION['acount_type']==3)
$query = "select * from user_crm,reg_cors,user_cors,subjects,cors 
where user_cors.cors_ID=reg_cors.no and user_crmBranches='$_SESSION[Branches]' and user_crm.ID=user_cors.user_ID and cors.cors_ID=subjects.cors_ID
 and address=cors.ID  and  Supervisor='$ss' and   user_cors.com='$com' order by dates DESC";
...
?>
 <tr>
                         ...
                         <td align="right"><p align="center">
							<font color="#FF0000"><?php echo $row['reg_price']; ?></font></td> 
