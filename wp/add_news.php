...
<table id='example1'  class="table table-bordered table-striped"  dir=rtl >
					...
					<tr>
						...
						<span lang="ar-sa">الخبر</span> (عربي)</font></td>
...
$sql="insert into news  set  address='$T1',news='$S1',address_en='$T2',news_en='$S22',photo='$name',day='$day',mans='$mans',year='$year',sorc='$T3'  ";
