...
<table id='example1'  class="table table-bordered table-striped"  dir=rtl >
					...
					<tr>
						...
						<font face="Droid Arabic Kufi" size="2">اسم التصيف</font></span></td>
...
<table id='example1'  class="table table-bordered table-striped"  dir=ltr >
						...
						<span lang="ar-sa"><b>
						<font face="Droid Arabic Kufi" size="2">اسم التصنيف</font></b></span></td>
										<td align="center" width="4%" bgcolor="#EBEBEB" dir="ltr">
										<b>
...
<input     name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $i++;?>" style="width: 100%"    ></font></span></td>
										<td align="center" width="68%" dir="ltr">
										<font face="Droid Arabic Kufi" size="2">				 										
<input  required="required"    name="T1[]" id="T2" size="20"     class="form-control" style="width: 100%; height:30; font-family:Droid Arabic Kufi; text-align:left" dir="ltr" required="required" placeholder="Menu Name" value="<?php echo $row['category_name']; ?>" ></font></td>
									...
									<input  required="required"   type=hidden class=input2 id=roomno0 size=19 name=ID[] style="width: 243; height: 21" dir="rtl" value="	<?php echo $row['category_ID']; ?>"></font></font></td>
									</tr>
<?php
}
?>
...
echo '<meta http-equiv="refresh" content="1;url=add_categories.php">';
}
}
...
$sql="UPDATE categories set category_name='{$_POST['T1'][$i]}' where category_ID='{$_POST['ID'][$i]}'";
if(@mysqli_query($conn,$sql))
{
echo '<meta http-equiv="refresh" content="1;url=add_categories.php">';
}
