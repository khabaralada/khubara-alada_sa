...
<?php
$i=0;
$query = "select reg_cors.no,Status,notes.ID,amount,Paid,date,time,Notes,user_crm.name,user_ID,notes.com,notes.cash   from user_crm,reg_cors,notes
...
?>								
 ...
 <input  type=hidden name="no1" size="20"     class="form-control"   dir="rtl" value="<?php echo $row['no']; ?>">
							...
							<?php if($row['com']==1) echo 'الصندوق'; ?>
							<?php if($row['com']==2) echo 'الشركة'; ?> -
