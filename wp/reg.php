						...
						<table id='example1' class="table table-bordered table-striped" dir=ltr>
							...
							<form method="POST" name="form2" action="<?php echo ($self); ?>">
								...
								<tbody>
									<?php
									include("../config.php");
									$result = mysqli_query($conn, "select* from subjects,cors where cors.cors_ID=subjects.cors_ID order by ID DESC");
									$i = 0;
									$c = 0;
									...
									?>
										<tr>
											<td align="right" dir="rtl">
												...
												<font face="Droid Arabic Kufi" size="2"><b>
														...
														if ($_SESSION['acount_type'] != 1) {
															$q2 = "AND sponsor=" . $auth_user_id;
														} else {
															$q2 = '';
														}
														$result1 = mysqli_query($conn, "select count(*) as co from  reg_cors where address='$row[ID]' " . $q2);
											...
											<td align="center">
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#s<?php echo $row['ID']; ?>">
													روابط التواصل الاجتماعي
												</button>

												</font>

												<!-- Start Modal Social Media -->
												<div class="modal fade" id="s<?php echo $row['ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel"> (<?php echo $row['cors_name']; ?>) روابط السوشيال ميديا لدورة</h5>
															...
															<div class="modal-body">
																...
																<div class="copy-link-container">
																	...
																	<div class="copy-link">
																		...
																		<div class="copy-link-inner">
																			<form data-copy=true>
																				<input type="text" value="<?php echo $websiteUrl . '/details1.php?ID=' . $row['ID'] . '&social=f&sponsor=' . $auth_user_id; ?>" data-click-select-all class="copy-link-input" readonly />
																...
																<div class="copy-link-container">
																	...
																	<div class="copy-link">
																		...
																		<div class="copy-link-inner">
																			<form data-copy=true>
																				<input type="text" value="<?php echo $websiteUrl . '/details1.php?ID=' . $row['ID'] . '&social=t&sponsor=' . $auth_user_id; ?>" data-click-select-all class="copy-link-input" readonly />
																				<button value="Copy" type="submit" class="copy-link-button btn btn-info">
																					<span class="material-icons">Copy</span>
																				</button>
																			</form>
																...
																<div class="copy-link-container">
																	...
																	<div class="copy-link">
																		...
																		<div class="copy-link-inner">
																			<form data-copy=true>
																				<input type="text" value="<?php echo $websiteUrl . '/details1.php?ID=' . $row['ID'] . '&social=i&sponsor=' . $auth_user_id; ?>" data-click-select-all class="copy-link-input" readonly />
																				<button value="Copy" type="submit" class="copy-link-button btn btn-info">
																					<span class="material-icons">Copy</span>
																				</button>
																			</form>
																...
																<div class="copy-link-container">
																	...
																	<div class="copy-link">
																		...
																		<div class="copy-link-inner">
																			<form data-copy=true>
																				<input type="text" value="<?php echo $websiteUrl . '/details1.php?ID=' . $row['ID'] . '&social=w&sponsor=' . $auth_user_id; ?>" data-click-select-all class="copy-link-input" readonly />
																				<button value="Copy" type="submit" class="copy-link-button btn btn-info">
																					<span class="material-icons">Copy</span>
																				</button>
																			</form>
											...
											<td align="right">
												...
												<?php echo $row['cors_name_en']; ?></font>
											</td>
											<td align="right">
												<?php echo $row['contact_hours']; ?></font>
											</td>
											<td align="right">
												<?php echo $row['start_date_en']; ?></font>
											</td>

											<td align="right">
												<?php echo $row['cors_name']; ?></font>
											</td>
											<td align="right">
												<?php echo $c; ?>

												<input required="required" type=hidden class=input2 id=roomno0 size=19 name=ID[] style="width: 243; height: 21" dir="rtl" value="	<?php echo $row['ID']; ?>"></font>
											</td>
										</tr>
									<?php
									}
