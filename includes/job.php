...
$mail->Host = 'server46.hostwhitelabel.com';                  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'info@nahtonline.com';    // SMTP username
$mail->Password = 'Y&9%gVz0PYDC';                         // SMTP password
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['form_sex'] != '' AND $_POST['form_post'] != '' AND $_POST['form_message'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'ØáÈ ÊæÙíÝ ÌÏíÏ';

        $botcheck = $_POST['form_botcheck'];

        $toemail = 'spam.info@nahtonline.com'; // Receiver Email Address
        $toname = 'NAHT';                // Receiver Name
