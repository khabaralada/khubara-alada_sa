...
<li ><a href="contact.php">اتصل بنا</a></li>
  ...
  <div class="main-content">
    ...
    <!-- Section: Courses -->
          <?
 $ss= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['order_ID']), ENT_QUOTES, "utf-8")); 
		 ...
		 <div class="col-sm-12 col-md-4">
            <div class="sidebar sidebar-left mt-sm-30 ml-30 ml-sm-0">
              ...
              <div class="widget border-1px bg-silver-deep p-15">
                <h4 class="widget-title line-bottom-theme-colored-2">التأكيد و بيانات الدفع (
				<font color="#FF0000"> <?php echo $row[reg_price]; ?> ريال</font>  )</h4>
...
function fetch_select1(payment)
{
   $.ajax({
     type: 'post',
     url: 'savepayment.php',
    ...
    Moyasar.init({
        ...
        amount: '<?php echo $row[reg_price]*100; ?>',
        currency: 'SAR',
...
</script><hr><hr> <div class="form-group">
                  <input   class="form-control" type="hidden"  name='cors'  value="<? echo $ss; ?>"  required="">
                  <label>الاسم </label>: <? echo $row['name']; ?>
                  </div>
                  <div class="form-group">
                                    <label>البريد الالكتروني </label>: <? echo $row['mail']; ?>
</div>

<div class="form-group">
                                    <label>وسيلة الاتصال</label>: <? echo $row['mobile']; ?>
...
<div class="form-group">
                                    <label>الهوية الوطنية</label>: <? echo $row['iqama']; ?>
                  ...
                  <div class="form-group">
                                     ...
                                     <label>ملاحظات</label>: <? echo $row['eqt']; ?>
