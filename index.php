...
if (isset($_POST['contact'])) {
  ...
  if ($responseKeys["success"]) {
    ...
    $message .= "<<center><img src=" . $site_url . "/logo.webp height=70px></center>";
    $to =  $site_email;;
...
<body class="rtl">
                ...
                <li class="m-0 pl-0 pr-10">
                  <ul>
                    <li><a href="#" title="" class="dropdown-toggle text-white" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <img src="images/flag-ar.webp" alt="" />
                        AR</a>
                      <ul class="dropdown-menu">
                        <li><a href="en" title=""><img src="images/flag-1.webp" alt="" />
                            EN</a></li>
        ...
        <div class="container pt-20 pb-20">
          <div class="row ">
            <div class="col-xs-12 col-sm-12 col-md-3">
              <a class=" flip sm-pull-center mb-15" href="index.php"><img src="images/logo-wide.webp" style=" height:70px" alt=""></a>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 mobileHide">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                  ...
                  <a class=" flip sm-pull-center mb-15" href="index.php"><img src="logo1.webp" style=" height:70px" alt=""></a>
          ...
          <div id="rev_slider_home_wrapper" class="rev_slider_wrapper" data-alias="news-gallery34" style="margin:0px auto; background-color:#ffffff; padding:0px; margin-top:0px; margin-bottom:0px;">
            ...
            <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
              <ul>
                ...
                <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slide-bg-4.webp" data-rotate="0" data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                  <!-- MAIN IMAGE -->
                  <img src="images/slide-bg-4.webp" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  <!-- LAYERS -->
                  <!-- LAYER NR. 1 -->
                  <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0 bg-theme-colored-transparent-4" id="slide-3-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-width="full" data-height="full" data-whitespace="normal" data-transform_idle="o:1;" data-transform_in="opacity:0;s:1500;e:Power3.easeInOut;" data-transform_out="opacity:0;s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="500" data-basealign="slide" data-responsive_offset="on" style="z-index: 5;background-color:rgba(0, 0, 0, 0.35);border-color:rgba(0, 0, 0, 1.00);">
                  </div>
                ...
                <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slide-bg-5.webp" data-rotate="0" data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                  <!-- MAIN IMAGE -->
                  <img src="images/slide-bg-5.webp" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  <!-- LAYERS -->
                  <!-- LAYER NR. 1 -->
                  <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0 bg-theme-colored-transparent-4" id="slide-3-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-width="full" data-height="full" data-whitespace="normal" data-transform_idle="o:1;" data-transform_in="opacity:0;s:1500;e:Power3.easeInOut;" data-transform_out="opacity:0;s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="500" data-basealign="slide" data-responsive_offset="on" style="z-index: 5;background-color:rgba(0, 0, 0, 0.35);border-color:rgba(0, 0, 0, 1.00);">
                  </div>
 ...
 where cors.cors_ID=subjects.cors_ID and  show_reg=1   order by rand() limit 10 ");
                        ...
                        <div class="author-thumb">
                          ...
                          while ($row1 = mysqli_fetch_array($result1)) {
                            ...
                            <? } else { ?>
                              ...
                              <? if ($row1['Branches'] == 3) { ?><img src="stus/dist/img/avatar2.webp" class="img-circle" style="width:54px;height:54px" alt="<? echo $row1['name']; ?>" /><? } else { ?>
                                <img src="stus/dist/img/avatar5.webp" class="img-circle" style="width:54px;height:54px" alt="<? echo $row1['name']; ?>" />
                            <? }
                                                                                                                                                                                      } ?>
      ...
      <section class="layer-overlay overlay-white-9" data-bg-img="images/bg/bg-pattern.webp">
        <div class="container pb-40">
          <div class="section-content">
            <div class="row">
              <div class="col-md-3">
      ...
      <section id="reservation" class="parallax layer-overlay overlay-theme-colored-8" data-bg-img="images/we-provide-bg.webp" data-parallax-ratio="0.4">
        <div class="container">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="owl-carousel-6col clients-logo transparent text-center">
                <?php
                for ($i = 1; $i <= 46; $i++) {
                  $filePath = "Logos_International/" . $i . ".webp";
                  if (!file_exists($filePath)) {
                    $filePath = "Logos_International/" . $i . ".webp";
                    if (!file_exists($filePath)) {
                      break;
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="owl-carousel-6col clients-logo transparent text-center">
                <?php
                for ($i = 1; $i <= 10; $i++) {
                  $filePath = "Logos_our_clients/" . $i . ".webp";
                  if (!file_exists($filePath)) {
                    $filePath = "Logos_our_clients/" . $i . ".webp";
                    if (!file_exists($filePath)) {
                      break;
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mt-5 mb-20" alt="" src="images/logo-white-footer.webp">
