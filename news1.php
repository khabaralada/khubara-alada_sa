...
$result=mysqli_query($conn,"select* from orgn  where 	ID='$ss' ");
while($row=mysqli_fetch_array($result))
{
echo $row['address'];
}
      ...
      <? }} ?>         
          ...
          <div class="col-md-3">
            <div class="sidebar sidebar-right mt-sm-30">
              <div class="widget">
                <h5 class="widget-title line-bottom">البحث عن الاخبار</h5>
              ...
              <div class="widget">
                <h5 class="widget-title line-bottom">تصنيف الآخبار</h5>
                <div class="categories">
                  <ul class="list list-border angle-double-right">
                    <?php
$C=0;
$result=mysqli_query($conn,"select DISTINCT year from news ORDER BY year DESC  ");
while($row=mysqli_fetch_array($result))
{
$C++;
?> <li><a  href="all_news.php?year=<? echo $row['year']; ?>" title="<? echo $row['year']; ?>">اخبار عام <? echo $row['year']; ?></a></li>
<? } ?>
                  </ul>
                </div>
              </div>
              <div class="widget">
                <h5 class="widget-title line-bottom">  اخر الاخبار</h5>
                <div class="latest-posts">
<?php
$C=0;
$result=mysqli_query($conn,"select * from news where photo!='-1.' ORDER BY ID DESC limit 5");
while($row=mysqli_fetch_array($result))
{
$C++;
?>                    
