...
<div  id="img1"  style="cursor:pointer;" dir="rtl" /><span class="btn btn-primary"  >  توجية إلي</span> : 
...
?>
                  ...
                  <div class="form-group">
                    <input class="form-control"   required       name="Subject" placeholder="Subject: عنوان الرسالة" dir="ltr" value="Fw:<? echo str_replace(array('Fw:','Re:'), array('',''),$row1['address']); ?>"      />
                  </div>
                  <div class="form-group">
...
<? include('footer.php'); ?>
    </div><!-- ./wrapper -->        <script src="plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
    <!-- Page Script -->
    <script>
      $(function () {
        //Add text editor
