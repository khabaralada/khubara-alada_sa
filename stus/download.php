...
<ul class="nav nav-tabs pull-right">
                  ...
                  <li  class="active"><a href="download.php?cors_ID=<? echo $row[cors_ID]; ?>"  >المصادر ومحتوى البرنامج </a></li>
...
$query1 = "select * from cors_file where cors_ID='$row[cors_ID]' ";
$result1 = mysqli_query($conn,$query1);
...
?>                    
                    ...
                    <div class="panel box box-info">
                      <div class="box-header with-border">
                        <h4 class="box-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $row1['cors_file_ID']; ?> ">
                           <i class="fa  fa-plus-square"></i> <b> <?php echo $row1['file_title']; ?>
                          </b>
                          </a>
                        </h4>
                      </div>
                      <div id="collapse<?php echo $row1['cors_file_ID']; ?>" class="panel-collapse collapse <?php if($C==1) echo 'in'; ?>">
                        <div class="box-body">
   ...
   <div class="row"> 
 <div class="form-group col-lg-10"><i class="fa  fa-circle"></i> تحميل واستعراض  <?php echo $row1['file_title']; ?></div> 
 <div class="form-group col-lg-2"><label><a href="cors_files/<?php echo $row1['cors_file']; ?>"  ><i class="fa fa-download    "></i> استعراض </a></label></div> 
  </div> 
