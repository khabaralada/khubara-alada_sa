...
<body onLoad="init()">
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"><br><br><br> 
...
<tr>
										...
										<b>
										<span class="auto-style14">يشهد <? echo $Branches_title; ?> وبالتعاون مع شركة اميال الوطنية التجارية <br>بأن 
 <? if($pran==3)
												{
												echo 'المتدربة';
												}
										...
										<div align="center">
											<table border="0" width="100%" cellspacing="0" cellpadding="0" height="151"  >
												...
												<tr>
													...
													<br><img src="sign.png" height="82" width="235"></span></td>
