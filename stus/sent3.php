...
<h1><small>المهام المرسلة</small></h1>
</section>
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li ><a href="mailbox.php"><i class="fa fa-inbox"></i> المهام الواردة<span class="label label-primary pull-right">         
                                                                   <?
include ("conn.php");
$query1 = "select count(Recepion)as Recepion from  inbox,student   where student.iqama=inbox.Recepion    and iqama='$_SESSION[username]' and msg_delete=0 ";
...
?></span></a></li>
                    <li class="active"><a href="sent.php"><i class="fa fa-envelope-o"></i> المهام المرسلة</a></li>
 
 
                    <li><a href="trash.php"><i class="fa fa-trash-o"></i> Trash - المحذوفات<span class="label label-waring pull-right"> <?
include ("conn.php");
$query1 = "select count(Recepion)as Recepion from  inbox,student   where student.iqama=inbox.Recepion    and iqama='$_SESSION[username]' and msg_delete=1 ";
$result1 = mysqli_query($conn,$query1);
while($row1=mysqli_fetch_array($result1))
{
echo $co=$row1['Recepion'];
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    ...
                    <a href="sent.php" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
                    <!-- /.pull-right -->
                  </div>
...
include ("conn.php");
$i=0;
$query1 = "select * from  inbox,student   where student.iqama=inbox.Sender and iqama='$_SESSION[username]' and send_delete=0 ";
$result1 = mysqli_query($conn,$query1);
...
?>                     
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="read-mail1.php?msg_ID=<? echo $row1['msg_ID']; ?>"><?
...
$sql="update inbox set send_delete='1' where msg_ID='$msg_ID'";
