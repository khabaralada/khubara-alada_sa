...
<div class="box-body">
<p style="text-align: left"> <a href="add_Section_ch.php" class="btn btn-info btn-flat">فتح دورات اللغة الصينية جديدة</a></p>
...
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors_type='لغة صينية' order by cors_no DESC ";
else
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors.Branches='$_SESSION[Branches]' and cors_type='لغة صينية' order by cors_no DESC ";
...
while($row1=mysqli_fetch_array($result1))
{
 ...
 ?></td>
                        <td>
				<a href="edit_tahely_ch.php?ID=<? echo $row['ID']; ?>"><i class="fa fa-pencil btn btn-info btn-sm "></i></a></td>
                      </tr>
                    <? }} ?>
                    </tbody>
