                    ...
                    <thead>
                      <tr>
						...
						المستوى</th>
                         ...
                         <th><p align=center>تاريخ بداية المستوى</th>
                         <th><p align=center>تاريخ نهاية
...
while($row1=mysqli_fetch_array($result1))
{
 ...
 ?></td>
                        <td>
				<a href="print_report1.php?section_Id=<? echo $row['ID']; ?>" target=_blank><i class="fa fa-print btn btn-Warning btn-sm "></i></a></td>
                      </tr>
                    <? }} ?>
                    </tbody>
