...
?>
 ...
 <tr>
   ...
   <td align="center"><a href="show_mail.php?section_Id=<? echo $row['0']; ?>" class="   fa fa-envelope-o   btn btn-Danger  btn-sm ">
  ( <? 
$query1 = "select count(*) as co    from stu_mail   where   section_Id='$row[0]'";
$result1 = mysqli_query($conn,$query1);
while($row1=mysqli_fetch_array($result1))
{
  echo $row1['co'];   } ?> )   - الرسائل والتعليقات </a>  </td>
