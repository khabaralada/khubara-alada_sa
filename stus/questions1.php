...
include ("conn.php");
$result=mysqli_query($conn,"select * from subjects,branches where   Branches_ID=Branches  and cors_ID in (select cors_ID from cors where traning_name='$_SESSION[user_ID]') order by cors,Branches_ID ");
$i=0;
