...
$com=$row['com']; 
$d = d_date($_POST[start_date]); // الدالة 
$m = m_date($_POST[start_date]); // الدالة 
$y = y_date($_POST[start_date]); // الدالة 
...
$d = d_date($_POST[end_date]); // الدالة 
$m = m_date($_POST[end_date]); // الدالة 
$y = y_date($_POST[end_date]); // الدالة 
		...
		<tr>
			...
			<div align="center">
				<table border="1" width="80%" cellpadding="2" style="border-collapse: collapse">
					...
					<tr>
						<td align="center">من <? echo $_POST[start_date] ; ?> الي <? echo $_POST[end_date] ; ?> </td>
...
for ($i=$date_from; $i<=$date_to; $i+=86400) {
  $date=date("Y-m-d", $i); 
      ...
      ?>					
					...
					<span lang="en-gb"><? //echo $dd=date("d", $i);
					 $CCC++; echo $dd=$CCC;
 ?></span></td><? } ?> 
  ...
  $date=date("Y-m-d", $i); 
      ...
      ?>
				...
				<tr>
					...
					<td align="center"   dir="rtl" bgcolor="#BCE8F1">
					<font size="2" color="#000000">اسم المتدرب </font> </td><td align="center"   dir="rtl" bgcolor="#BCE8F1">
					رقم الهوية</td>
					<td align="center"   dir="rtl" bgcolor="#BCE8F1">
					الرقم الوظيفي</td>
<?
...
include ("conn.php");
$c1=0;
$result=mysqli_query($conn,"select* from stu_sec,student,cors  where student.stu_id=stu_sec.stu_id and cors.ID=stu_sec.section_Id and   cors.com='$_SESSION[name]'");
while($row=mysqli_fetch_array($result))
{
$c1++;
    $ID_reg=$row['ID_reg'];
...
<tr>
					...
					<td align="center"  ><? echo $row['stu_name_ar']; ?></td><td align="center"  ><? echo $row['iqama']; ?></td>
					<td align="center"  ><? echo $row['jobID']; ?></td>
<?
