...
<h1><small>  					فتح دورة لغة صينية جديدة / شعبة
...
end_date_en='$newDate1',cors_no='$cors_no',class='$class',day1='$day1',time1='$time1',time2='$time2',day2='$day2',cors_type='لغة صينية',com='$com',live='$lives'  ";
...
$sql="insert into class set Building='$Branches',section_Id='$last_id',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='لغة صينية'  ";
if(mysqli_query($conn,$sql))
{
}
}
