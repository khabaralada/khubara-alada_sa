...
$sql="update cors set Branches='$Branches',cors_ID='$cors_ID',traning_name='$traning_name',start_date='$start_date',end_date='$end_date',start_date_en='$start_date_en',
end_date_en='$end_date_en',cors_no='$cors_no',class='$class',day1='$day1',time1='$time1',time2='$time2',day2='$day2',cors_type='دبلوم',com='$com',live='$lives' where ID='$ID'";
...
$sql="insert into class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='دبلوم'  ";
if(mysqli_query($conn,$sql))
{
}

$sql="update   class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='دبلوم'  where section_Id='$ID'";
if(mysqli_query($conn,$sql))
{
}
...
document.getElementById("snackbar3").style.visibility = "hidden";
 ...
 window.setTimeout("hideMsg()", 2000); </script>';
?><meta http-equiv="refresh" content="2;url=mang_cors_deplome.php"><?
