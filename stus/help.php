...
?>
          ...
          <div class="col-md-6">
            ...
            <ul class="list-inline sm-pull-none sm-text-center text-right text-white mb-sm-20 mt-10">
              <li class="m-0 pl-10"> <a href="wp" class="text-white "><i class="fa fa-user-o mr-5 text-white"></i> دخول </a> </li>
...
<? if($row22['type']==5){ ?><li><a href="page2.php?ID=<? echo $row22['sub_ID']; ?>"><? echo $row22['sub']; ?></a></li>  <? } ?>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a1.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-medal  text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class=""> التسجيل بالدورات والدخول للمنصة</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a2.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-users text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">دخول المدرب للمنصة
 </p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a3.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-notebook  text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">الدليل الارشادي للمنصة التعليمية وطريقة التسجيل
</p>
              </div>
            </div>
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a5.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-wallet  text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">  آلية استقبال الشكاوى
</p>
              </div>
            </div>
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a6.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-phone text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">     الشكاوى والمقترحات والاستفسارات وقنوات التواصل</p>
              </div>
            </div>
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file1.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">    دليل طريقة دخول الدورة التدريبية </p>
              </div>
            </div>
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file2.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">   دليل سياسة وادأب التواصل للبرنامج التدريبي </p>
              </div>
            </div>
            
 <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file3.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">  سياسة التغذية الراجعة  </p>
              </div>
            </div>         
 ...
 <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file4.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class=""> سياسة الحضور  </p>
              </div>
            </div>         

  <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file5.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class=""> سياسة درجات تقييم الدورة التدريبية</p>
              </div>
            </div>    

  <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file7.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class=""> دليل رفع الواجبات المنزلية</p>
              </div>
            </div>   
            
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="zoom.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-zoom text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class=""> دليل كيفية استخدام برنامج  zoom</p>
              </div>
            </div>   
            
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="file.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-zoom text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">المعارف والمهارات والكفايات المطلوبة للمدرب</p>
              </div>
            </div>   
   ...
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file9.pdf" class="icon icon-circled icon-lg" data-bg-color="#5f0006">
                  <i class="pe-7s-zoom text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">المعارف والمهارات والكفايات المطلوبة للمتدرب</p>
              </div>
            </div>   
