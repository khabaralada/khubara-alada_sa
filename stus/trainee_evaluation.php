...
<h1><small>
                  ...
                  قياس رضا المتدربين عن تقديم البرامج بنمط التدريب الإلكتروني</small></h1>
</section>
...
$query= "select * from test_trainee_evaluation where ID_reg='$ID_reg' and cors_ID='$cors_ID' ";
$result = mysqli_query($conn,$query);
$rows = mysqli_num_rows($result );
...
include ("conn.php");
 $query = "select * from questions_student where cors_ID='$lessons_ID'   ORDER BY  rand()   ";
$result = mysqli_query($conn,$query);
$rows = mysqli_num_rows($result );
if($rows > 0 )
{
...
<div class="form-group col-lg-12      ">
  ...
  <p dir="rtl" align="center"><font color="#FF0000"><b>تم انهاء استبيان قياس رضا المتدربين عن تقديم البرامج بنمط التدريب الإلكتروني
...
include ("conn.php");
$query8 = "select * from test_trainee_evaluation,questions_student   where
 questions_student.cors_ID='$lessons_ID' and ID_reg='$ID_reg' and test_trainee_evaluation.question_ID=questions_student.question_ID  ";
...
$sql="insert into test_trainee_evaluation set user_ID='$stu',cors_ID='$cors_ID',question_ID='$question_ID',Answer='$Answer',stu_choice='$R',scor='$scor',ID_reg='$ID_reg',que_type='$section' ";
