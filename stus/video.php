...
<ul class="nav nav-tabs pull-right">
                  ...
                  <li  class="active"><a href="video.php?cors_ID=<? echo $row[cors_ID]; ?>"  >دليل الفيديو </a></li>
...
$query1 = "select * from video_cors where cors_ID='$row[cors_ID]' ";
$result1 = mysqli_query($conn,$query1);
...
?>                    
                    ...
                    <div class="panel box box-<?php if($C==1) echo 'primary'; else echo 'primary'; ?>">
                      <div class="box-header with-border">
                        <h4 class="box-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $row1['video_cors_ID']; ?> ">
                           <i class="fa  fa-plus-square"></i> <b> <?php echo $row1['video_cors']; ?>
                          </b>
                          </a>
                        </h4>
                      </div>
                      <div id="collapse<?php echo $row1['video_cors_ID']; ?>" class="panel-collapse collapse <?php if($C==1) echo 'in'; ?>">
                        <div class="box-body">
 ...
 <div class="form-group col-lg-4"><label><a href="<?php echo $row1['video_title']; ?>"  target=_blank ><i class="fa  fa-play-circle   "></i> استعراض وتشغيل الفيديو </a></label></div> 
 <?php if(strpos($row1[video_title], 'youtube') !== false){
 ?>
 <div class="form-group col-lg-12">
 <iframe class="embed-responsive-item" src="<? echo str_replace('watch?v=','embed/',$row1['video_title']); ?>" style="width:100%;height:550px " frameborder="0" allowfullscreen></iframe></div>
