              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    ...
                    <a href="mailbox.php" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
                    <!-- /.pull-right -->
                  </div>
...
include ("conn.php");
$i=0;
$query1 = "select * from  inbox,student   where student.iqama=inbox.Recepion    and iqama='$_SESSION[username]'  and msg_delete=0";
$result1 = mysqli_query($conn,$query1);
...
?>
                          ...
                          <? echo $row1['time']; ?><input type="hidden" name="msg_ID[]" size="20" value="<? echo $row1['msg_ID']; ?>"></td>
                        </tr><? }} ?>
