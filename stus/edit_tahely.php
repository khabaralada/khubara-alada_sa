...
include ("conn.php");
if($Branches==0)
$query = "select * from subjects where   cors='دورة تأهلية' ";
else
$query = "select * from subjects where Branches='$Branches' and cors='دورة تأهلية'";
$result = mysqli_query($conn,$query);
$rows = mysqli_num_rows($result );
if($rows > 0 )
{
...
end_date_en='$end_date_en',cors_no='$cors_no',class='$class',day1='$day1',time1='$time1',time2='$time2',day2='$day2',cors_type='دورة تأهلية',com='$com',live='$lives'  where ID='$ID'";
...
$sql="insert into class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='دورة تأهلية'  ";
if(mysqli_query($conn,$sql))
{
}

$sql="update   class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='دورة تأهلية'  where section_Id='$ID'";
if(mysqli_query($conn,$sql))
{
}
...
document.getElementById("snackbar3").style.visibility = "hidden";
 ...
 window.setTimeout("hideMsg()", 2000); </script>';
?><meta http-equiv="refresh" content="2;url=mang_cors.php"><?
