...
<h1><small>
 دورات اللغة الصينية Chinese courses
</small></h1>
</section>
...
{
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors_type='لغة صينية' and teacher.username='$_SESSION[username]' and end_date>='$ar_date' order by cors_no DESC";
}
else
{
if($_SESSION['Branches']==0)
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors_type='لغة صينية' and end_date>='$ar_date' order by cors_no DESC";
else
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors.Branches='$_SESSION[Branches]' and cors_type='لغة صينية'  and end_date>='$ar_date' order by cors_no DESC";
}
