...
<? } ?>
                      ...
                      <input  name="The_rest_of_the_question"  size="20"      class="form-control"  >
                       </div>
 
 
                        <div class="form-group col-lg-12">
                      <label>عنوان 1</label>
                      <input  name="sub1"  size="20"      class="form-control"  >
                       </div>

                       <div class="form-group col-lg-12">
                      <label>عنوان 2</label>
                      <input  name="sub2"   size="20"     class="form-control"  >
                       </div>

                       <div class="form-group col-lg-12">
                      <label>النص</label>
                      <textarea  name="lontext"         class="form-control"  ></textarea>
                       </div>
                      ...
                      <input    type="file" name="myFile" size="20" accept="image/png, image/jpeg">
                       ...
                       <div class="form-group col-lg-12">
                      <label>صوت</label>
                      <input    type="file" name="myFile1" size="20" accept="audio/mp3">
                       </div>
...
<table id='example1'  class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
                         ...
                         <th><p align=center><p align="center">باقي السؤال </th>
                         ...
                         <th><p align=center><p align="center">الصوت</th>
                         <th><p align=center><p align="center">النوع</th>
...
$query = "select * from questions where cors_ID='$cors_ID'  order by question_ID";
...
?>
 <tr>
	<form role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <td align="right"><p align="center"><? echo $row['The_rest_of_the_question']; ?></td>
                        ...
                        <td align="right"><p align="center"><? if($row['sound']!='-1.' and $row['sound']!='') { ?><a href="attachment/<? echo $row['sound']; ?>"><i class="fa  fa-youtube-play btn btn-Success btn-sm"></i></a><? } ?></td>
						
                        <td align="right"><p align="center"><? echo $row['section']; ?></td>
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['cors_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="insert into questions set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',cors_ID='$cors_ID',question='$T1',choice1='$T2',choice2='$T3',choice3='$T4',choice4='$T5',Answer='$T6',img='$img',sound='$sound'";
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['cors_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="update questions set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',cors_ID='$cors_ID',question='$T1',choice1='$T2',choice2='$T3',choice3='$T4',choice4='$T5',Answer='$T6'  where question_ID='$iddd'";
if(mysqli_query($conn,$sql))
{
...
$sql="delete from 	questions where question_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
