...
$query = "select DISTINCT teacher_name,id_card,Branches_name,phone,email,teacher_id  from cors,subjects,teacher,branches  
 where   branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and teacher.username='$_SESSION[username]'  order by cors_no DESC";
...
<?
 ...
 ?></td>
                        <td>
<a href="table.php?teacher_id=<? echo $row['teacher_id']; ?>" target=_blank>استعراض</a></td>
                      </tr>
                    <? }} ?>
                    </tbody>
