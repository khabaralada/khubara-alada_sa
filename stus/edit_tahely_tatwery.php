...
include ("conn.php");
if($Branches==0)
$query = "select * from subjects where   cors='تطويري' ";
else
$query = "select * from subjects where Branches='$Branches' and cors='تطويري'";
$result = mysqli_query($conn,$query);
$rows = mysqli_num_rows($result );
if($rows > 0 )
{
...
<?php } } ?>
 ...
 <option><? echo $row2['com']; ?></option> <option></option>
<?
$i=0;
include ("conn.php");
...
end_date_en='$end_date_en',cors_no='$cors_no',class='$class',day1='$day1',time1='$time1',time2='$time2',day2='$day2',cors_type='تطويري',com='$com',live='$lives'  where ID='$ID'";
...
$sql="insert into class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='تطويري'  ";
if(mysqli_query($conn,$sql))
{
}

$sql="update   class set Building='$Branches',section_Id='$ID',class_no='$class',day='$day1',day2='$day2',time='$time1',end_time='$time2',cors_type='تطويري'  where section_Id='$ID'";
if(mysqli_query($conn,$sql))
{
}
...
document.getElementById("snackbar3").style.visibility = "hidden";
 ...
 window.setTimeout("hideMsg()", 2000); </script>';
?><meta http-equiv="refresh" content="2;url=mang_cors_tatwery.php"><?
