                  ...
                  <table id="example1" class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
						...
						<span style="font-weight: 400; font-size: 8pt">التقارير</span></th>
                      </tr>
                    </thead>
                    <tbody>
                     <?
...
?><br>بداية الدورة :<? echo $row['start_date']; ?><br>
                        ...
                        <td>
						<span style="font-size: 8pt">الدرجة:<? echo $row['scor']; ?> <br><? echo $row['Rate']; ?></span></td>
                        <td width="47">
						<a href="table11.php?section_Id=<? echo $row['0']; ?>">
						<span style="font-size: 8pt">جدول المحاضرات</span></a><hr>  <a href="detalis1.php?ID_reg=<? echo $row['ID_reg']; ?>">
						الحضور والغياب </a></td>
                      	</form>
