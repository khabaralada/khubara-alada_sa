...
$query11 = "select count(absence.ID_reg) as co  from absence,stu_sec    where    stu_sec.ID_reg=absence.ID_reg and date_en='$dd' and absence.teacher='$teacher_id11' and absence.type='1'";
