...
<input  type=hidden name="lessons_ID"   size="20"   value="<?php echo $_GET['lessons_ID']; ?>" required="required"   class="form-control"  >
</div> 
...
<table    class="table table-bordered table-striped"  >
                    ...
                    <tbody>
                     <?php
include ("conn.php");
$query = "select * from lesson_video where lessons_ID='$_GET[lessons_ID]' ";
...
?>
 <tr>
                        ...
                        <td align="right"><p align="center"><?php echo $row['video_lessons_ID']; ?></td>
                        <td align="right"><p align="center"><?php echo $row['video_lessons']; ?></td>
                        <td align="right"><p align="center"><?php echo $row['video_title']; ?></td>
 
 
						
                        <td align="center">
                        <a href="" data-id="<?php echo $row['video_lessons_ID']; ?>" data-target="#myModaEdit<?php echo $row['video_lessons_ID']; ?>" data-toggle="modal" class="btn btn-info btn-sm   "><i class="fa fa-pencil"></i> </a>
                        <a href="" data-id="<?php echo $row['video_lessons_ID']; ?>" data-target="#myModaDelete<?php echo $row['video_lessons_ID']; ?>" data-toggle="modal" class="btn btn-danger btn-sm  "><i class="fa fa-trash-o "></i></a>
</td>
                      	</form>
                      </tr><div class="example-modal">
            <div class="modal" id="myModaEdit<?php echo $row['video_lessons_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">                <form action="" method="post">
                  ...
                  <div class="modal-body">
					...
					<input  type=hidden name="idds"   size="20"   value="<?php echo $row['video_lessons_ID']; ?>" required="required"   class="form-control"  >
...
<div class="form-group col-lg-12">
<label>العنوان</label>
<input  name="T1"   size="20"   required="required"   class="form-control" value="<?php echo $row['video_lessons']; ?>"  >
</div>  
<div class="form-group col-lg-12">
<label>رابط الفيديو</label>
<input  name="T2"   size="20"   required="required"   class="form-control" value="<?php echo $row['video_lessons']; ?>"  >
</div>  
...
<input type="submit" class="btn btn-success"  value="حفظ التغييرات" name="edit"> 
 ...
 <div class="example-modal">
            <div class="modal" id="myModaDelete<?php echo $row['video_lessons_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
               <form action="" method="post">
                  <div class="modal-header">
					<b><font face="Droid Arabic Kufi" size="5">حذف بيانات : <?php echo $row['name']; ?></font><font size="5"></font></b>
					<input  type=hidden name="idd"   size="20"   value="<?php echo $row['video_lessons_ID']; ?>" required="required"   class="form-control"  >
...
if (isset($_POST['add'])) {
 ...
 $lessons_ID= mysqli_real_escape_string($conn,$_POST['lessons_ID']); 
 
$sql="insert into lesson_video set video_lessons='$T1',video_title='$T2',lessons_ID='$lessons_ID'  ";
if(mysqli_query($conn,$sql))
{
...
$sql="update lesson_video set video_lessons='$T1',video_title='$T2'  where video_lessons_ID='$idds'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
...
$sql="delete from lesson_video where video_lessons_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
