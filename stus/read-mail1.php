              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
					...
					المهام الواردة<span class="label label-primary pull-right"><?
include ("conn.php");
...
?></span></a></li>
                    <li><a href="sent.php"><i class="fa fa-envelope-o"></i> 
					المهام المرسلة</a></li>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    ...
                    <h5>To: <font face="Droid Arabic Kufi"> <?
...
{
?><meta http-equiv="refresh" content="2;url=sent.php"><?
