...
<h1><small>  اسئلة استبيان المتدربين
</small></h1>
</section>
...
<table id='example1'  class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
                         ...
                         <th><p align=center><p align="center">الاختيار5</th>
...
$query = "select * from questions_student where cors_ID='$lessons_ID'  order by question_ID";
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['cors_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="insert into questions_student set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',cors_ID='$lessons_ID',question='$T1',choice1='$T2',choice2='$T3',choice3='$T4',choice4='$T5',Answer='$T6',img='$img',sound='$sound'";
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['lessons_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="update questions_student set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',
...
$sql="delete from 	questions_student where question_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
