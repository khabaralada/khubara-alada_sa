...
<h1><small>
<i class="fa fa-pencil btn btn-info btn-sm "></i> الدورات التدريبية
</small></h1>
</section>
...
<div class="form-group  col-lg-6">
                    ...
                    <!-- input states -->
                    <div class="form-group  col-lg-6"  >
                      <label class="control-label" for="inputSuccess">     عدد الساعات  </label>
...
<input  name="price1"   size="20"    required="required"    class="form-control" value="<? echo $row['price']; ?>" >
 </div>
...
<input    type="file" name="myFile" size="20"   > <br>
                 ...
                 <div class="form-group col-lg-4">
<label>ارفاق الحقيبة الدراسية</label>
...
$sql="insert into subjects set cors_name='$T1',cors_code='$T2',contact_hours='$T3',credits='$T4',type='$T5',cors='$cors',Branches='$Branches',absences='$absences',
...
word_en='$S22',
size='$size',
price='$price',price1='$price1',

hours='$T4',photo='$name1',cors_files='$img',cors_files2='$name2',Semester='$level'";
