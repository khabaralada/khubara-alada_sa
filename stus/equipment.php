...
<head>
<meta charset="UTF-8">
<title>متطلبات وتجهيزات البرنامج التدريبي</title>
...
<h1><small>متطلبات وتجهيزات البرنامج التدريبي</small></h1>
</section>
...
<label>متطلبات وتجهيزات البرنامج التدريبي</label>
...
<table    class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
                        ...
                        <th align="right"><p align="center">متطلبات وتجهيزات البرنامج التدريبي</th>
                        <th align="right"><p align="center"></th>
                      </tr>
                    </thead>
                    <tbody>
                     <?php
include ("conn.php");
$query = "select * from equipment where cors_ID='$_GET[cors_ID]' ";
...
?>
 <tr>
                        ...
                        <td align="right"><p align="center"><?php echo $row['equipment_ID']; ?></td>
                        <td align="right"><p align="center"><?php echo $row['equipment']; ?></td>
 
 
						
                        <td align="center">
                        <a href="" data-id="<?php echo $row['equipment_ID']; ?>" data-target="#myModaEdit<?php echo $row['equipment_ID']; ?>" data-toggle="modal" class="btn btn-info btn-sm   "><i class="fa fa-pencil"></i> </a>
                        <a href="" data-id="<?php echo $row['equipment_ID']; ?>" data-target="#myModaDelete<?php echo $row['equipment_ID']; ?>" data-toggle="modal" class="btn btn-danger btn-sm  "><i class="fa fa-trash-o "></i></a>
</td>
                      	</form>
                      </tr> 
<div class="example-modal">
            <div class="modal" id="myModaEdit<?php echo $row['equipment_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">                <form action="" method="post">
                  ...
                  <div class="modal-body">
					...
					<input  type=hidden name="idds"   size="20"   value="<?php echo $row['equipment_ID']; ?>" required="required"   class="form-control"  >
...
<div class="form-group col-lg-12">
<label>متطلبات وتجهيزات البرنامج التدريبي</label>
<input  name="T1"   size="20"   required="required"   class="form-control" value="<?php echo $row['equipment']; ?>"  >
</div>  
...
<input type="submit" class="btn btn-success"  value="حفظ التغييرات" name="edit"> 
          ...
          <div class="example-modal">
            <div class="modal" id="myModaDelete<?php echo $row['equipment_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
               <form action="" method="post">
                  <div class="modal-header">
					<b><font face="Droid Arabic Kufi" size="5">حذف بيانات : <?php echo $row['name']; ?></font><font size="5"></font></b>
					<input  type=hidden name="idd"   size="20"   value="<?php echo $row['equipment_ID']; ?>" required="required"   class="form-control"  >
...
$sql="insert into equipment set equipment='$T1',cors_ID='$cors_ID'  ";
if(mysqli_query($conn,$sql))
{
...
$sql="update equipment set equipment='$T1'  where equipment_ID='$idds'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
...
$sql="delete from equipment where equipment_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
