...
{
$query = "select * from cors,subjects,teacher,branches   where branches.Branches_ID=cors.Branches and  teacher.teacher_id=cors.traning_name and subjects.cors_ID=cors.cors_ID and cors_type='تطويري' and teacher.username='$_SESSION[username]' order by cors_no DESC";
}
else
{
...
while($row1=mysqli_fetch_array($result1))
{
 ...
 ?></td>
				...
				<a href="print_report.php?section_Id=<? echo $row['ID']; ?>" target=_blank><i class="fa fa-print btn btn-Warning btn-sm "></i></a></td>
                        <td>
				<a href="scor.php?section_Id=<? echo $row['ID']; ?>" >استعراض</a></td>
                      </tr>
                    <? }} ?>
                    </tbody>
