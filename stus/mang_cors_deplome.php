...
<p style="text-align: left"> <a href="add_Section_deplome.php" class="btn btn-warning btn-flat">فتح دبلوم جديد</a></p>
...
while($row1=mysqli_fetch_array($result1))
{
 ...
 ?></td>
				...
				<a href="test_trainee_evaluation.php?ID=<? echo $row['ID']; ?>"><i class="fa fa-user btn btn-info btn-sm "></i></a></td>
                        <td>
				<a href="edit_deplome.php?ID=<? echo $row['ID']; ?>"><i class="fa fa-pencil btn btn-info btn-sm "></i></a></td>
                      </tr>
                    <? }} ?>
                    </tbody>
