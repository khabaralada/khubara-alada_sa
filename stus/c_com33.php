...
$result=mysqli_query($conn,"select* from stu_sec,cors,student,subjects where subjects.cors_ID=cors.cors_ID and  
 stu_sec.stu_id=student.stu_id and section_Id='$ID_reg' and cors.ID=section_Id  order by section_Id ");
...
$name1=$row8['name1'];
 $branches_logo=$row8['branches_logo'];
									...
									<tr>
										...
										<p align="center">
										<img border="0" src="44.png" width="381" height="55"></td>
									</tr>
...
<? echo str_replace($western_arabic, $eastern_arabic,$date33); ?>/<? echo str_replace($western_arabic, $eastern_arabic,$date22); ?>/<? echo str_replace($western_arabic, $eastern_arabic,$date11); ?> 
										...
										للتدريب التقني والمهني برقم<span lang="ar-sa"> 
										 </span> ( <? echo str_replace($western_arabic, $eastern_arabic,$row['cors_code']); ?> )</span></span></p>
										</td>
									</tr>
										...
										<div align="center">
											<table border="0" width="100%" cellspacing="0" cellpadding="0" height="151"  >
												...
												<tr>
													...
													<span class="auto-style3">
													<span class="auto-style27">المـــوافـق : <? echo str_replace($western_arabic, $eastern_arabic,date ( "d-m-Y" ));   ?> 
													م
													 </span></span>
													 </strong>
													<span class="auto-style3">
												...
												<tr>
													<td valign="top" class="auto-style32" style="width: 337px" rowspan="2">
													 
													 <img src="sign.png" height="60"  >
 </td>
...
echo $ID_reg; ?>)</strong></font></td>
					...
					</table> <span class="pagebreak"> </span >
<? } ?>
</body>
</html>