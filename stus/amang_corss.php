                    ...
                    <thead>
                      <tr>
						...
						رقم الدورة</th>
                         ...
                         <th><p align=center>رسائل الجوال + الواتسأب</th>
...
{
 ?> <a href="show_stu.php?section_Id=<? echo $row['0']; ?>"><? echo $row1['co']; ?> - استعراض</a> <?
 }
 ?></td>
                        <td>
				<p align="center"> <a href="print_report.php?section_Id=<? echo $row['ID']; ?>" target=_blank><i class="fa fa-print btn btn-Warning btn-sm "></i></a></td>
                       <td>
						<p align="center">
...
while($row1=mysqli_fetch_array($result1))
{
 ?> <a href="content.php?section_Id=<? echo $row['0']; ?>"><? echo $row1['co']; ?> - استعراض</a> <?
 }
 ?>						
