...
<h1><small>المحاور الرئيسة</small></h1>
</section>
...
<table    class="table table-bordered table-striped"  >
                    <thead>
                      <tr>
                        ...
                        <th align="right"><p align="center">المحاور الرئيسة</th>
                        <th align="right"><p align="center"></th>
                      </tr>
                    </thead>
                    <tbody>
                     <?php
include ("conn.php");
$query = "select * from main_axes where cors_ID='$_GET[cors_ID]' ";
...
?>
 <tr>
                        ...
                        <td align="center">
                        <a href="" data-id="<?php echo $row['Main_axes_ID']; ?>" data-target="#myModaEdit<?php echo $row['Main_axes_ID']; ?>" data-toggle="modal" class="btn btn-info btn-sm   "><i class="fa fa-pencil"></i> </a>
                        <a href="" data-id="<?php echo $row['Main_axes_ID']; ?>" data-target="#myModaDelete<?php echo $row['Main_axes_ID']; ?>" data-toggle="modal" class="btn btn-danger btn-sm  "><i class="fa fa-trash-o "></i></a>
</td>
                      	</form>
                      </tr>
                      
                      <div class="example-modal">
            <div class="modal" id="myModaEdit<?php echo $row['Main_axes_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">                <form action="" method="post">
                  ...
                  <div class="modal-body">
					...
					<input  type=hidden name="idds"   size="20"   value="<?php echo $row['Main_axes_ID']; ?>" required="required"   class="form-control"  >
...
<div class="form-group col-lg-12">
<label>الفئة </label>
<input  name="T1"   size="20"   required="required"   class="form-control" value="<?php echo $row['Main_axes']; ?>"  >
</div>  
...
<input type="submit" class="btn btn-success"  value="حفظ التغييرات" name="edit"> 
 ...
 <div class="example-modal">
            <div class="modal" id="myModaDelete<?php echo $row['Main_axes_ID']; ?>" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
               <form action="" method="post">
                  <div class="modal-header">
					<b><font face="Droid Arabic Kufi" size="5">حذف بيانات : <?php echo $row['name']; ?></font><font size="5"></font></b>
					<input  type=hidden name="idd"   size="20"   value="<?php echo $row['Main_axes_ID']; ?>" required="required"   class="form-control"  >
...
$sql="insert into main_axes set Main_axes='$T1',cors_ID='$cors_ID'  ";
if(mysqli_query($conn,$sql))
{
...
$sql="update main_axes set Main_axes='$T1'  where Main_axes_ID='$idds'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
...
$sql="delete from main_axes where Main_axes_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
