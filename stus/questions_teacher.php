...
$query = "select * from questions_teacher where cors_ID='$lessons_ID'  order by question_ID";
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['cors_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="insert into questions_teacher set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',cors_ID='$lessons_ID',question='$T1',choice1='$T2',choice2='$T3',choice3='$T4',choice4='$T5',Answer='$T6',img='$img',sound='$sound'";
...
$cors_ID= mysqli_real_escape_string($conn,htmlspecialchars(intval($_GET['lessons_ID']), ENT_QUOTES, "utf-8")); 
 ...
 $sql="update questions_teacher set sub1='$sub1',sub2='$sub2',lontext='$lontext',The_rest_of_the_question='$The_rest_of_the_question',section='$cat',
...
$sql="delete from 	questions_teacher where question_ID='$idd'";
if(mysqli_query($conn,$sql))
{
$last_id = mysqli_insert_id($conn);
echo '<script>
