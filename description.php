...
$result=mysqli_query($conn,"select* from research  where 	ID='$ss' ");
while($row=mysqli_fetch_array($result))
{
echo $row['address'];
}
...
?> 
 <article class="post clearfix mb-0">
                <div class="entry-header">
                  <div class="post-thumb thumb"> <img  src="news/<? echo $row['photo']; ?>"   alt="" class="img-responsive img-fullwidth"> </div>
                </div>
               ...
               <? if($row['sorc']!="") { ?>   <p><b><font color="#800000">المصدر :</font></b> <?  echo $row['sorc']; ?></a></p> <? } ?>
                  ...
                  <div class="mt-30 mb-0">
                    <h5 class="pull-left flip mt-10 mr-20 text-theme-colored">مشاركة : </h5>
      ...
      <? }} ?>         
          ...
          <div class="col-md-3">
            <div class="sidebar sidebar-right mt-sm-30">
              <div class="widget">
                <h5 class="widget-title line-bottom">البحث عن الابحاث والمقالات</h5>
              ...
              <div class="widget">
                <h5 class="widget-title line-bottom">تصنيف الابحاث والمقالات</h5>
                <div class="categories">
                  <ul class="list list-border angle-double-right">
                    <?php
$C=0;
$result=mysqli_query($conn,"select DISTINCT year from research ORDER BY year DESC  ");
while($row=mysqli_fetch_array($result))
{
$C++;
?> <li><a  href="all_research.php?year=<? echo $row['year']; ?>" title="<? echo $row['year']; ?>">ابحاث ومقالات عام <? echo $row['year']; ?></a></li>
<? } ?>
                  </ul>
                </div>
              </div>
              <div class="widget">
                <h5 class="widget-title line-bottom">  الابحاث والمقالات</h5>
                <div class="latest-posts">
<?php
$C=0;
$result=mysqli_query($conn,"select * from research where photo!='-1.' ORDER BY ID DESC limit 5");
while($row=mysqli_fetch_array($result))
{
$C++;
?>                    
                  <article class="post media-post clearfix pb-0 mb-10">
                    <a class="post-thumb" href="#"><img src="news/<? echo $row['photo']; ?>"  style="width:75px;height:50px"   alt=""></a>
                    <div class="post-right">
                      <h5 class="post-title mt-0"><a href="news.php?ID=<? echo $row['ID']; ?>"><? echo $row['address']; ?></a></h5>
