          ...
          <div class="row">
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a1.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
            ...
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a2.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
            ...
            <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a3.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a5.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="a6.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file1.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file2.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
 ...
 <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file3.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
 ...
 <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file4.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
  ...
  <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file5.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
  ...
  <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file7.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
   ...
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="zoom.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
   ...
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="file.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
   ...
   <div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="stus/cors_files/file9.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
...
<div class="col-md-4">
              <div class="icon-box hover-effect border-1px border-radius-10px text-center bg-white p-15 pt-40 pb-30">
                <a href="plane.pdf" class="icon icon-circled icon-lg" data-bg-color="#1a134b">
                  <i class="pe-7s-user text-white font-48"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-1 font-20 mt-15"> </h4>
                <p class="">خطة تدريبية للمدربين على المحاور الثلاثة</p>
              </div>
            </div>
