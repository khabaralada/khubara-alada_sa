            ...
            <div class="row">
              <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
                  ...
                  <h5 class="font-13 text-black m-0"> +966 11 2093090 </h5>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
              ...
              <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="widget no-border sm-text-center mt-10 mb-10 m-0">
				  ...
				  <a href="#" class="font-12 text-gray text-uppercase"> موقع الشركة </a>
                  <h5 class="font-13 text-black m-0"> حي السلام-شارع الشباب-الرياض-العربية السعودية </h5>
...
<? }} ?>               
<li><a href="all_news.php">أخبار</a></li>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/we-provide-bg1.webp">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12">
              <h2 class="text-theme-colored2 font-36">الإدارة  </h2>
    ...
    <section id="team" class="bg-silver-deep">
      <div class="container pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">الهيئة <span class="text-theme-colored2">الإدارية</span></h2>              
              <p class="text-uppercase mb-0">لدينا فريق إدارة متخصص وذو خبرة</p>
...
<?
$result=mysqli_query($conn,"select* from teachers where teachers_type=2");
while($row=mysqli_fetch_array($result))
{
