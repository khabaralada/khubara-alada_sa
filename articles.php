...
if($ss=="")
$result=mysqli_query($conn,"select* from research where type=2   order by ID DESC  ");
else
$result=mysqli_query($conn,"select* from research  where type=2  and year='$ss' order by ID DESC  ");
