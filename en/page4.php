                  ...
                  <div class="entry-meta media no-bg no-border mt-0 mb-10">
                    <div class="media-body pl-0">
                      <div class="event-content pull-left flip">
                        <h6 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a  href="news1.php?ID=<? echo $row['ID']; ?>" ><?  echo $row['address_en']; ?></a></h6>
                             
                      </div>
                    </div>
                  </div>
                  <p class="mt-5"><? //echo strip_tags(substr($row['news_en'],0,510)); ?></p>
                  <a class="btn btn-default btn-flat font-12 mt-10 ml-5" href="news1.php?ID=<? echo $row['ID']; ?>"> More</a>
                </div>
              </article>
            </div>
            <? }} ?>
