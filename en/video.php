...
$result=mysqli_query($conn,"select* from photo  where   page='$ss' and img_type=2");
while($row=mysqli_fetch_array($result))
{
?> 
<div class="gallery-item photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="../images/portfolio/<? echo $row['photo']; ?>" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a class="popup-youtube" href="<? echo $row['url']; ?>"><i class="fa fa-youtube-play"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
...
$result22=mysqli_query($conn,"select * from sub  order by sort1 ASC limit 2");
while($row22=mysqli_fetch_array($result22))
{
?>
<? if($row22['type']==1){ ?><li><a href="about.php?ID=<? echo $row22['sub_ID']; ?>"><? echo $row22['sub_en']; ?></a></li>  <? } ?>
...
?>              
              <article class="post media-post clearfix pb-0 mb-10">
                <a class="post-thumb"  href="news.php?ID=<? echo $row['ID']; ?>" >
										<img   src="../news/<? echo $row['photo']; ?>"  style="width:60px;height:40px" alt=""></a>
                <div class="post-right">
                  <h5 class="post-title mt-0 mb-5"><a href="news.php?ID=<? echo $row['ID']; ?>"><? echo substr($row['address_en'],0,70); ?> </a></h5>
