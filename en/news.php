 ...
 <article class="post clearfix mb-0">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
					<img  src="../news/<? echo $row['photo']; ?>"   alt="" class="img-responsive img-fullwidth"> </div>
                </div>
      ...
      <? }} ?>         
          ...
          <div class="col-md-3">
            <div class="sidebar sidebar-right mt-sm-30">
              <div class="widget">
                <h5 class="widget-title line-bottom">Searching for news</h5>
                <div class="search-form">
                  <form>
                    <div class="input-group">
                      <input type="text" placeholder="Searching " class="form-control search-input">
              ...
              <div class="widget">
                <h5 class="widget-title line-bottom">News Categories</h5>
...
{
$C++;
?> <li><a  href="all_news.php?year=<? echo $row['year']; ?>" title="<? echo $row['year']; ?>">News of the year <? echo $row['year']; ?></a></li>
<? } ?>
                  </ul>
                </div>
              </div>
...
<img src="../news/<? echo $row['photo']; ?>"  style="width:75px;height:50px"   alt=""></a>
                    <div class="post-right">
                      <h5 class="post-title mt-0"><a href="news.php?ID=<? echo $row['ID']; ?>"><? echo $row['address_en']; ?></a></h5>
