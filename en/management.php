          ...
          <div class="row"> 
            <div class="col-md-12">
              ...
              <ol class="breadcrumb   mt-10 white">
                ...
                <li class="active">Our Management Team</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section id="team" class="bg-silver-deep">
      <div class="container pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">Our <span class="text-theme-colored2">Management</span> Team</h2>              
              <p class="text-uppercase mb-0">WE HAVE A DEDICATED AND EXPERIENCED MANAGEMENT TEAM</p>
