    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="../images/we-provide-bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12">
              <h2 class="text-theme-colored2 font-36">Our Teachers</h2>
    ...
    <section id="team" class="bg-silver-deep">
      <div class="container pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">Our <span class="text-theme-colored2">Teachers</span> and <span class="text-theme-colored2">Trainers</span></h2>              
              <p class="text-uppercase mb-0">WE HAVE HIGHLY QUALIFIED TEACHERS AND TRAINERS</p>
...
<?
$result=mysqli_query($conn,"select* from teachers where teachers_type=1");
while($row=mysqli_fetch_array($result))
{
