 ...
 <article class="post clearfix mb-0">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
					<img  src="../testimonial/<? echo $row['photo']; ?>"   alt="" class="img-responsive img-fullwidth"> </div>
                </div>
                  ...
                  <div class="entry-meta media no-bg no-border mt-15 pb-20">
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h3 class="entry-title text-white text-uppercase pt-0 mt-0"><a href="news.php?ID=<? echo $row['ID']; ?>"><? echo   $row['address_en'] ; ?> </a></h3>
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 comment</span>                       
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Like</span>
                      </div>
                    </div>
                  </div>
                  <p class="mb-15" align="justify"><?php echo $row['news_en']; ?></p>
               <? if($row['sorc']!="") { ?>   <p><b><font color="#800000">Source:</font></b> <?  echo $row['sorc']; ?></a></p> <? } ?>
 
 
                  <div class="mt-30 mb-0">
                    <h5 class="pull-left flip mt-10 mr-20 text-theme-colored">Share the news : </h5>
      ...
      <? }} ?>         
          ...
          <div class="col-md-3">
            <div class="sidebar sidebar-right mt-sm-30">
              <div class="widget">
                <h5 class="widget-title line-bottom">Find events</h5>
                <div class="search-form">
                  <form>
                    <div class="input-group">
                      <input type="text" placeholder="Find" class="form-control search-input">
              ...
              <div class="widget">
                <h5 class="widget-title line-bottom">Classification of events</h5>
...
{
$C++;
?> <li><a  href="all_testimonial.php?year=<? echo $row['year']; ?>" title="<? echo $row['year']; ?>">Events and events for the year <? echo $row['year']; ?></a></li>
<? } ?>
                  </ul>
                </div>
              </div>
...
<img src="../testimonial/<? echo $row['photo']; ?>"  style="width:75px;height:50px"   alt=""></a>
                    <div class="post-right">
                      <h5 class="post-title mt-0"><a href="testimonial.php?ID=<? echo $row['ID']; ?>"><? echo $row['address_en']; ?></a></h5>
